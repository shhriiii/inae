...
const Committee = () => {
  ...
  const organizingSecretaries = [
    ...
    // },
    {
      ...
      role: "Program Chair , Assistant Professor, Mechanical Engg, NIT Raipur",
    ...
    {
      name: "Dr. Saurav Raj",
      role: "Assistant Professor, Electircal Engg. NIT  Raipur",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV9Cbv1M4GDSIvT8s6vY4kP4rP2DI4xhclOVOiy8alM8M4x3qm17PNNqk&s=10",
      email: "sraj.ee@nitrr.ac.in",
    },
  ];
