    ...
    <>
      ...
      <section className="submission">
        <div className="submission-container">
          ...
          <p>
            Participation steps and achievements of hackathon are given below:
          </p>

          <ol>
            <li>
              Participants will submit a full-length description of their
              innovative idea/concept addressing a defined real-world problem
              or challenge.
            </li>

            <li>
              Selected teams will develop and demonstrate a working prototype,
              solution, or proof of concept during the hackathon.
            </li>

            <li>
              The proposed solution should demonstrate innovation, technical
              feasibility, sustainability, societal relevance, and potential
              for practical implementation.
            </li>

            <li>
              Best Hackathon Team/Project Awards will be presented to
              outstanding teams based on evaluation by the expert jury.
            </li>

            <li>
              The content will be published in program proceedings. Same
              procedure will also be followed for project exhibition/Idea.
            </li>
          </ol>
          ...
          <p>
            Develop innovative solutions for hackathon in any of the following
            thematic areas, as given below:
          </p>

          <ul>
            <li>
              HT1: Eco-Friendly Housing Models with Near-Zero Carbon Footprint
            </li>

            <li>
              HT2: AI-Based Building Energy Monitoring and Optimization Systems
            </li>

            <li>
              HT3: Smart Irrigation Systems Based on Plant Health and
              Environmental Sensing
            </li>

            <li>
              HT4: AI-Enabled Predictive Maintenance for Industrial Equipment
            </li>

            <li>
              HT5: AI-Assisted Decision Support Systems for Engineering and
              Public Services
            </li>

            <li>
              HT6: Smart Healthcare Devices for Remote Monitoring and
              Preventive Care
            </li>

            <li>
              HT7: Real-Time Disaster Detection, Early Warning, and Emergency
              Response Systems
            </li>

            <li>
              HT8: Smart City Solutions for Sustainable Urban Infrastructure
            </li>

            <li>
              HT9: IoT-Enabled Smart Farming Devices for Precision Agriculture
            </li>

            <li>
              HT10: AI-Based Scrap Management and Intelligent Waste Segregation
              Systems
            </li>

            <li>
              HT11: Circular Economy Solutions for Resource Recovery and
              Sustainable Manufacturing
            </li>

            <li>
              HT12: Clean Energy Technologies and Renewable Energy Innovations
            </li>

            <li>
              HT13: Industry 5.0 Solutions for Human-Centric Smart
              Manufacturing
            </li>

            <li>
              HT14: Digital Twin Applications for MSMEs and Smart Factories
            </li>

            <li>
              HT15: Bio-Inspired Engineering Solutions for Sustainable
              Technologies
            </li>

            <li>
              HT16: Any Other Relevant Topic in Sustainable Technology and
              Innovation
            </li>
          </ul>
...
<li> 
  ...
  >
     Registration Link 
          ...
          <ul>
            <li>
              Participation is open to students from Schools (Classes
              VIII–XII), Polytechnics, Undergraduate and Postgraduate
              programmes.
            </li>

            <li>
              Each team shall consist of a minimum of <strong>2</strong> and a
              maximum of <strong>5</strong> students.
            </li>

            <li>
              Each institution may nominate multiple teams.
            </li>

            <li>
              One faculty mentor may guide multiple teams; mentors shall not
              participate during the competition.
            </li>

            <li>
              Interdisciplinary teams from different departments,
              institutions or academic levels are encouraged.
            </li>
          </ul>
          ...
          <ul>
            <li>
              Interested teams must register online and submit an abstract
              before the deadline.
            </li>
            ...
            <li>
              Abstracts will be evaluated by the Technical Committee, and
              results will be communicated within 7 days.
            </li>
          </ul>
          ...
          <ul>
            <li>
              A working prototype, proof-of-concept or functional model must
              be demonstrated during the Hackathon.
            </li>

            <li>
              Submission of an abstract alone does not qualify a team for
              final participation.
            </li>

            <li>
              Teams are expected to develop their prototype between abstract
              submission and the event.
            </li>
          </ul>
          ...
          <ul>
            <li>
              Approximately one month before the Hackathon, shortlisted teams
              shall deliver an online/offline progress presentation.
            </li>
            ...
            <li>
              The committee may provide technical suggestions for improvement.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>Presentation (maximum 10 slides)</li>
            <li>
              Prototype photographs/videos (maximum 5 images, up to 25 MB)
            </li>
            <li>Source code / design files (where applicable)</li>
            <li>Declaration of originality</li>
            <li>
              The organizing committee may grant an extension of up to seven
              days if required.
            </li>
          </ul>
          ...
          <ul>
            <li>
              The Technical Committee will review project readiness.
            </li>

            <li>
              Only teams receiving final approval (Green Signal) will be
              permitted to present during the Hackathon.
            </li>
          </ul>
          ...
          <ul>
            <li>
              Each shortlisted team must physically demonstrate its working
              prototype.
            </li>
          ...
          <table className="submission-table">
            ...
            <tbody>
              ...
              <tr>
                <td>Feasibility and Scalability</td>
                <td>15</td>
              </tr>

              <tr>
                <td>Prototype Functionality</td>
                <td>15</td>
              </tr>

              <tr>
                <td>Practical & Societal Impact</td>
                <td>15</td>
              </tr>
          ...
          <ul>
            <li>
              All submissions must represent the team's original work.
            </li>

            <li>
              Plagiarism or intellectual property violations will result in
              immediate disqualification.
            </li>

            <li>
              Open-source libraries and publicly available resources may be
              used with proper acknowledgment.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>Distribution of participant kits</li>
            <li>
              Briefing on rules, schedule, evaluation criteria and code of
              conduct
            </li>
          </ul>
          ...
          <p>
            Teams will analyse the problem, identify user requirements,
            prepare the solution architecture and develop an implementation
            strategy.
          </p>
          ...
          <p>
            Participants may use open-source software, development platforms
            and standard engineering tools.
          </p>
          ...
          <ul>
            ...
            <li>Source Code / Design Files (where applicable)</li>
            <li>
              Online submission of working concepts/prototypes is mandatory.
            </li>
            <li>Late submissions shall not be accepted.</li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Teams shall work independently without external assistance.
            </li>

            <li>
              Plagiarism or intellectual property infringement will result in
              immediate disqualification.
            </li>

            <li>
              The decision of the Jury and Organizing Committee shall be final
              and binding.
            </li>
            ...
            <li>
              Selected participants may be recommended for INAE Student
              Membership, subject to approval by the Indian National Academy
              of Engineering (INAE).
            </li>
          </ul>
